...
<section class="herobanner" style="background: url(<?php echo get_field('historie_zdjecie_w_tle_sekcji_2','options'); ?>) center center;
    background-size:cover;">
    <div class="container-fluid">
        <h1><?php echo get_field('historie_tytul_sekcji_2','options'); ?></h1>
    </div>
</section>
...
<section class="historiefeed">
    <div class="container">
        <div class="col-md-12 section-title">
            <?php echo get_field('historie_opis_sekcji_2','options'); ?>
        </div>
        <div class="row">
